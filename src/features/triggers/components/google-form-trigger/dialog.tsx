        ...
        <Dialog open = {open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Use this webhook URL in your Google Form's Apps Script to trigger the workflow.
                    </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                   ...
                   <div className = "rounded-lg bg-muted p-4 space-y-2">
                        ...
                        <ol className = "text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                            ...
                            <li>Click on the three dots menu and then Script Editor</li>
                            <li>Copy and paste the script below</li>
                            <li>Replace WEBHOOK_URL with your webhook URL above</li>
                            <li>Save and click "triggers" and then Add Trigger</li>
                            <li>Choose: From - On from submit - Save</li>
                        </ol>
                   </div>
